...
export const AdminSEOManager: React.FC = () => {
  ...
  const activeConfig: PageMetaConfig = pageConfigs[selectedPath] || {
    ...
    title: '',
    description: '',
    canonicalUrl: `${siteSettings?.siteUrl || 'https://www.tutorialsandcode.in'}${selectedPath === '/' ? '' : selectedPath}`,
    keywords: '',
    robots: 'index, follow',
  ...
  const handleAddCustomPath = () => {
    ...
    const newConf: PageMetaConfig = {
      ...
      canonicalUrl: `${siteSettings?.siteUrl || 'https://www.tutorialsandcode.in'}${clean}`,
      robots: 'index, follow',
