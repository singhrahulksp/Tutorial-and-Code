...
export const AdminSettingsPage: React.FC = () => {
  ...
  return (
    <AdminLayout
      ...
      subtitle="Configure publication metadata, monitor live Firestore cloud synchronization, and manage persistent storage."
    >
      {toast && (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        {/* Left: General Settings & Subscribers */}
        <div className="lg:col-span-7 space-y-8">
          
          {/* General Editorial Configuration */}
          ...
          <div className="p-6 bg-white dark:bg-[#0a0a0a] border border-zinc-100 dark:border-zinc-800">
            ...
            <div className="max-h-48 overflow-y-auto divide-y divide-zinc-100 dark:divide-zinc-800 text-xs font-mono">
              {subscribers.map((sub) => (
        ...
        {/* Right: Firebase Firestore Cloud Status & Backups */}
        <div className="lg:col-span-5 space-y-8">
          ...
          {/* XML Sitemap & SEO Indexation */}
          <div className="p-6 bg-white dark:bg-[#0a0a0a] border border-zinc-100 dark:border-zinc-800 space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="text-xs font-black uppercase tracking-[0.2em] text-zinc-400 flex items-center gap-2">
                <Globe className="w-4 h-4 text-emerald-600" />
                Dynamic XML Sitemap & Crawl Index
              </h3>
              <span className="text-[10px] font-bold uppercase tracking-widest px-2 py-0.5 bg-emerald-100 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-300">
                Sitemaps.org 0.9
              </span>
            ...
            <p className="text-xs text-zinc-500 leading-relaxed">
              Dynamically crawls all {posts.filter(p => p.status === 'published').length} published articles, categories, and author profiles directly from Firestore to produce indexable XML endpoints.
            </p>

            <div className="pt-2 flex flex-col sm:flex-row gap-2">
              <a
                href="/sitemap.xml"
                className="flex-1 py-2.5 px-3 text-xs font-bold uppercase tracking-wider bg-zinc-900 dark:bg-zinc-100 text-white dark:text-black text-center hover:opacity-90 transition-opacity flex items-center justify-center gap-1.5"
              >
              ...
              <a
                href="/sitemap"
                className="py-2.5 px-4 text-xs font-bold uppercase tracking-wider border border-zinc-300 dark:border-zinc-700 hover:bg-zinc-100 dark:hover:bg-zinc-800 text-center transition-colors"
              >
