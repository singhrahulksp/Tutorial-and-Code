    ...
    <div className="w-full max-w-[96rem] mx-auto px-3 sm:px-6 lg:px-8 py-8">
      ...
      <div className="text-center space-y-3 mb-12 max-w-3xl mx-auto">
        ...
        <h1 className="text-3xl sm:text-5xl font-black uppercase tracking-tight text-neutral-900 dark:text-white">
          Contact Editorial Staff & Newsroom
        </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="p-6 sm:p-8 border border-zinc-100 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/40 space-y-4">
            <h2 className="text-sm font-black uppercase tracking-widest text-neutral-900 dark:text-white">
              Direct Communication Channels
            </h2>
            <p className="text-xs text-zinc-600 dark:text-zinc-400 leading-relaxed">
              We respond to peer review requests, technical errata, benchmarks verification, and open source contributions.
            </p>
            <div className="space-y-3 pt-2 text-xs">
              <div className="border-t border-zinc-200 dark:border-zinc-800 pt-3">
                ...
                <div className="text-zinc-500 font-mono mt-0.5">editor@tutorialsandcode.dev</div>
              </div>
              <div className="border-t border-zinc-200 dark:border-zinc-800 pt-3">
                <div className="font-bold text-neutral-900 dark:text-white uppercase tracking-wider text-[11px]">
                  Security & Errata Disclosures
                </div>
                <div className="text-zinc-500 font-mono mt-0.5">security@tutorialsandcode.dev</div>
              </div>
              <div className="border-t border-zinc-200 dark:border-zinc-800 pt-3">
                <div className="font-bold text-neutral-900 dark:text-white uppercase tracking-wider text-[11px]">
                  Syndication & RSS Feeds
                </div>
                <div className="text-zinc-500 font-mono mt-0.5">press@tutorialsandcode.dev</div>
              </div>
            </div>

            <div className="pt-4 border-t border-zinc-200 dark:border-zinc-800 text-xs text-zinc-400 font-mono flex items-center gap-2">
              <ShieldCheck className="w-4 h-4 text-blue-600 shrink-0" />
              <span className="truncate">PGP Fingerprint: 4A8F 9C21 881E B340 5D12 C9A0</span>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-7">
          <div className="p-6 sm:p-8 border border-zinc-100 dark:border-zinc-800 bg-white dark:bg-[#0a0a0a]">
            <h2 className="text-sm font-black uppercase tracking-widest text-neutral-900 dark:text-white mb-6 pb-2 border-b border-zinc-100 dark:border-zinc-800">
