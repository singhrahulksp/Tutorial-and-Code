        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {authors.map((author) => (
            ...
            >
              ...
              />
              <div>
                <h4 className="text-sm font-bold uppercase tracking-wider text-neutral-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                  {author.name}
                </h4>
                <div className="text-[10px] text-zinc-400 font-bold uppercase tracking-wider mt-0.5">{author.role}</div>
